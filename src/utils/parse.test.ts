...
describe("parse/1", () => {
  test("should parse markdown string into html string", () => {
    ...
    const expectedHtmlSlide1 = `<svg data-marpit-svg="" viewBox="0 0 1280 720" data-line="0"><foreignObject width="1280" height="720"><section id="1">
<h1 data-line="0">Slide 1</h1>
</section>
</foreignObject></svg>`;
    const expectedHtmlSlide2 = `<svg data-marpit-svg="" viewBox="0 0 1280 720" data-line="1"><foreignObject width="1280" height="720"><section id="2">
